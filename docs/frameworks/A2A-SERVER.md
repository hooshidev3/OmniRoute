---
title: "RouteChi A2A Server Documentation"
version: 3.8.40
lastUpdated: 2026-06-28
---

# RouteChi A2A Server Documentation

> Agent-to-Agent Protocol v0.3 — RouteChi as an intelligent routing agent
...
Returns the Agent Card describing RouteChi's capabilities, skills, and authentication requirements.
...
RouteChi exposes 6 A2A skills wired in `src/lib/a2a/taskExecution.ts::A2A_SKILL_HANDLERS`. Each skill module lives in `src/lib/a2a/skills/`.
...
The `list-capabilities` skill is particularly useful for external agents that need to discover what RouteChi exposes before sending API calls. It returns a structured markdown table artifact:

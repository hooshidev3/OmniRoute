...
- sebelum akun aktif habis, RouteChi menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, RouteChi menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, RouteChi menghasilkan ringkasan handoff
...
RouteChi menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, RouteChi mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`

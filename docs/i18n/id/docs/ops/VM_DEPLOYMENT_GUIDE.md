# RouteChi — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi RouteChi pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout RouteChi Anda. Jika Anda menaikkan
...
| 20128 | RouteChi   | Hanya localhost (melalui nginx) |

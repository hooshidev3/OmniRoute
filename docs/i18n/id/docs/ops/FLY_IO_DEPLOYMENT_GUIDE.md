# Panduan Deployment RouteChi di Fly.io
...
Dokumen ini menjelaskan metode deployment RouteChi di Fly.io yang telah terbukti berhasil, mencakup dua skenario utama:

# Dokumentasi Server A2A RouteChi (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — RouteChi sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi RouteChi.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas RouteChi. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan.                        |

# 🚀 RouteChi — The Free AI Gateway (Português (Portugal))
...
As credenciais OAuth embutidas no RouteChi estão cadastradas **apenas para `localhost`**. Quando você acessa o RouteChi em um servidor remoto (ex: `https://omniroute.meuservidor.com`), o Google rejeita a autenticação com:
...
- Nome: escolha qualquer nome (ex: `RouteChi Remote`)
...
1. O RouteChi abrirá a URL de autorização do Google
2. Após você autorizar, o Google tentará redirecionar para `localhost` (que falha no servidor remoto)
3. **Copie a URL completa** da barra de endereço do seu browser (mesmo que a página não carregue)
4. Cole essa URL no campo que aparece no modal de conexão do RouteChi
5. Clique em **"Connect"**

# RouteChi A2A Server Documentation (Português (Portugal))
...
| Skill              | Description                                                                                                                     |
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Routes prompts through RouteChi's intelligent pipeline. Returns response with routing explanation, cost, and resilience trace. |

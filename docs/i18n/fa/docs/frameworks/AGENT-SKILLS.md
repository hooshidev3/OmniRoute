...
- یک **URL خام GitHub** برای fetch زنده: `https://raw.githubusercontent.com/borhandarabi/omniroute/refs/heads/main/skills/{id}/SKILL.md`
...
```bash
BASE="https://raw.githubusercontent.com/borhandarabi/omniroute/refs/heads/main/skills"

...
OmniRoute محیط Docker را از طریق دو اکتشاف تشخیص می‌دهد:
...
2. پنل **Manual Token Import** در زیر کارت import از keychain ظاهر می‌شود. هنگامی که OmniRoute داکر را تشخیص دهد، این پنل پس از اولین تلاش ناموفق import از keychain به‌طور خودکار باز می‌شود.

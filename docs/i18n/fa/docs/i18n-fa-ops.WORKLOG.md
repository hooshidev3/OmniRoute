...
1. **Brand name**: All prose occurrences of "OmniRoute" → "OmniRoute". The source
   files already used "OmniRoute" in prose in most places; verified by spot-check.
...
4. **Technical identifiers preserved**:
   ...
   - CLI commands: `omniroute`, `omniroute`, `sqlite3 …`, `npm run …`, `gh api …`

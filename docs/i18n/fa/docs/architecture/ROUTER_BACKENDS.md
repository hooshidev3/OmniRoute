...
> **وضعیت:** پذیرفته‌شده · **زمینه:** [#5670](https://github.com/borhandarabi/omniroute/issues/5670)،
> [#5603](https://github.com/borhandarabi/omniroute/issues/5603) · **قرارداد:** `domain/routing/routerBackends.ts`
> (رجیستری تایپ‌شده — کد با [#5868](https://github.com/borhandarabi/omniroute/pull/5868) ادغام می‌شود)
...
قرارداد `domain/routing/routerBackends.ts` (کد با [#5868](https://github.com/borhandarabi/omniroute/pull/5868) ادغام می‌شود) هر موتور را یک‌بار با چرخه حیات، قابلیت‌ها، هویت سرویس، پورت پیش‌فرض، پیکربندی سلامت و پشتیبانی تلمتری اعلان می‌کند. مصرف‌کنندگان موتورها را از طریق `getRouterBackend(id)`، `listRouterBackends()` و `listRouterBackendsByCapability(cap)` جستجو می‌کنند به جای case-by-case هر sidecar.
...
[#5817](https://github.com/borhandarabi/omniroute/pull/5817) پیگیری می‌شود؛ تا زمان ادغام،
...
([#5869](https://github.com/borhandarabi/omniroute/pull/5869) manifest +
[#5870](https://github.com/borhandarabi/omniroute/pull/5870) `shouldTryBifrostForRequest`)،

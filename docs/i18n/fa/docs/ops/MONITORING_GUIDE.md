...
> **خلاصه**: OmniRoute به‌همراه پایش سلامت داخلی، خودنمایش ارائه‌دهنده، ردیابی سهمیه و قلاب‌های مشاهده‌پذیری عرضه می‌شود. این راهنما داشبورد، هشدارها و عیب‌یابی را پوشش می‌دهد.
...
OmniRoute دارای **۳ لایهٔ پایش** است:
...
OmniRoute از **۳ کانال هشدار** پشتیبانی می‌کند:
...
- ردیابی سهمیهٔ OmniRoute ممکن است **کهنه** باشد — حقیقت ارائه‌دهنده در بالادست است
...
- در غیر این صورت — **OmniRoute را متوقف کنید** و [راهنمای بازیابی فاجعه](./DATABASE_GUIDE.md#disaster-recovery) را دنبال کنید

...
OmniRoute آن URL را به Bifrost و CLIProxyAPI از طریق
header درخواست `X-OmniRoute-Provider-Manifest-Url` اعلان می‌کند. زمانی که
...
بتواند در نهایت توسط یک sidecar با تأخیر کمتر متعلق به آن شود، در حالی که OmniRoute

...
OmniRoute کنترل می‌کند کدام **مبدأهای مرورگری** مجاز به خواندن پاسخ‌های متقاطع‌مبدأ هستند
...
توجه جدی است، اما افشای OmniRoute **محدودتر از مورد عمومی** است،
...
> `Access-Control-Allow-Credentials: true` را ارسال کند. مسیر اشتراکی CORS در OmniRoute هرگز
> این کار را نمی‌کند.
...
CORS توسط خود OmniRoute اعمال می‌شود، بنابراین پراکسی عموماً نباید هدرهای
`Access-Control-*` را اضافه یا بازنویسی کند (هدرهای دوتایی مرورگرها را خراب می‌کند). TLS را
خاتمه دهید و فوروارد کنید — بگذارید OmniRoute به preflight پاسخ دهد:
...
مبدأهای مرورگری مجاز را در OmniRoute تنظیم کنید (`CORS_ALLOWED_ORIGINS` یا

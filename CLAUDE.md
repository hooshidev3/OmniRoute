...
**RouteChi** — unified AI proxy/router. One endpoint, 250 LLM providers, auto-fallback.
...
RouteChi has three related but distinct temporary-failure mechanisms. Keep their
...
repo** instead of polluting the main RouteChi tree.
...
RouteChi has **~48 quality-gate scripts** (`scripts/check/` + `scripts/quality/`) wired

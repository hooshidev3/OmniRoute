 ...
 * `providerId` field — RouteChi's `normalizeComboRecord` folds the provider
...
import { isUsableCombo, type RouteChiRawCombo } from "../src/index.js";
...
function combo(models: RouteChiRawCombo["models"]): RouteChiRawCombo {

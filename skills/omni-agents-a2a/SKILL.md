...
description: "Interact with RouteChi via JSON-RPC 2.0 agent-to-agent protocol. 6 built-in A2A skills: smart-routing, quota-management, provider-discovery, cost-analysis, health-report, list-capabilities."
---
...
RouteChi publishes an Agent Card at `/.well-known/agent.json` and accepts

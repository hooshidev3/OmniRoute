...
description: Synchronise RouteChi configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.
---
...
Authenticates with the RouteChi cloud worker for remote access.

---
name: omni-api-keys
description: Create, list, rotate, and revoke RouteChi API keys. Control per-key scopes, spending limits, and expiration. Keys gate access to all proxy and management endpoints.
---

/**
 * RouteChi Electron Desktop App - Main Process
 *
...
function resolveNodeExecutable(env = process.env) {
  ...
  // (e.g. RouteChi.app/Contents/MacOS/RouteChi). Spawning it with
...
function startNextServer() {
  ...
  if (changed) {
    ...
    try {
      ...
      const lines = [
        "# Auto-generated by RouteChi bootstrap",
        "",
  ...
  nextServer.stdout?.on("data", (data) => {
    ...
    if (text.includes("Ready") || text.includes("started") || text.includes("listening")) {
      ...
      if (isHeadless && !global.loggedHeadlessReady) {
        ...
        console.log("\n\x1b[32m✔ RouteChi Headless CLI Server is ready and listening!\x1b[0m");
  ...
  try {
    ...
    const desktopFileContent =
      [
        ...
        "Type=Application",
        "Name=RouteChi",
        "Comment=RouteChi Desktop Client",

# RouteChi Electron Desktop App

This directory contains the Electron desktop application wrapper for RouteChi.
...
1. Download `RouteChi.Setup.*.exe` from [Releases](https://github.com/borhandarabi/routechi/releases).
2. Run the installer.
3. Launch from Start Menu or Desktop shortcut.

**Portable (No Installation):**
1. Download `RouteChi.exe` from [Releases](https://github.com/borhandarabi/routechi/releases).

 ...
 *
 * Reference: RouteChi issue #2260 + comment 4459544580 (Open WebUI bypass).
 */
 ...
 * verified against opencode→RouteChi→Anthropic with claude-opus-4-7 OAuth.
 */
...
export const DEFAULT_SYSTEM_TRANSFORMS_CONFIG: SystemTransformsConfig = {
  providers: {
    [PROVIDER_CLAUDE]: {
      ...
      // usage` when opencode (or any non-claude-cli client) hits RouteChi's
 ...
 *
 * `providerId` matches RouteChi's provider key (`claude`,

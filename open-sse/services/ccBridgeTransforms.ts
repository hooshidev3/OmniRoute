 ...
 *
 * Goal: ensure the final request body RouteChi sends to Anthropic's
 ...
 * proven against the live RouteChi deployment (call log
...
/**
 * Compute the `cc_version` suffix per the RouteChi native-OAuth algorithm:

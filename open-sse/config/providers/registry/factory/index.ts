...
// local `droid` CLI. RouteChi already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through RouteChi.
//
...
// back to stored CLI credentials only when omitted. RouteChi does NOT read

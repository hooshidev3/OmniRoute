/**
 * POST /sync/:machineId — Store a sync bundle from a local OmniRoute instance.
...
export async function handleSync(request: Request, env: Env, machineId: string): Promise<Response> {
...
async function handleSyncPost(request: Request, env: Env, machineId: string): Promise<Response> {
  ...
  const settings =
    body.settings && typeof body.settings === "object"
      ...
      : {};
  const modelAliases =
    body.modelAliases && typeof body.modelAliases === "object"
...
async function handleSyncDelete(request: Request, env: Env, machineId: string): Promise<Response> {

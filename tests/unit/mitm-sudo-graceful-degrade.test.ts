 ...
 *
 * RouteChi's runtime Docker image (`Dockerfile`) runs as `USER node` (UID 1000)
 ...
 *
 * This mirrors upstream behavior (decolua/9router) extended to RouteChi's TS
 * fork and RouteChi's existing root-detection (`isRoot()`).
 */

 ...
 *
 * Serves the RouteChi A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the RouteChi Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "RouteChi AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 RouteChi agent skills (22 API + 20 CLI) " +

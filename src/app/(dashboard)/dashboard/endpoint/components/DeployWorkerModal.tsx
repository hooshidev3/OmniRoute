  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-96 max-w-full rounded-lg border border-border bg-surface p-6 shadow-lg">
        <h3 className="mb-1 text-sm font-semibold text-text-main">Auto-Deploy Cloud Worker</h3>
        <p className="mb-4 text-xs text-text-muted">
          Enter your Cloudflare credentials to automatically deploy the OmniRoute Cloud Worker. Your
          API token is used once for deployment and never stored.
        </p>

    ...
    <div className="space-y-4">
      <div className="rounded-lg border border-purple-500/25 bg-purple-500/5 p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="ml-auto text-xs text-text-subtle">{t("sharedWithFree")}</span>
        </div>

        <p className="text-xs text-text-muted mb-4">{t("captchaKeysDescription")} </p>
        ...
        <div className="mt-4 space-y-2 rounded-md border border-amber-500/20 bg-amber-500/5 p-3">
          ...
          <p className="text-xs text-text-subtle">
            <strong>A:</strong> Server-side crypto with pool tokens (~2s). <strong>B:</strong> Fresh
            token via Playwright + A (~5s). <strong>C:</strong> Full browser captcha (~10s, most
            reliable).
          </p>
        </div>

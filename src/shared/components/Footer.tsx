...
const footerLinks = {
  ...
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/diegosouzapw/RouteChi/discussions",
      external: true,
    },
  ],
  company: [
    { label: "About", href: "https://github.com/diegosouzapw/RouteChi", external: true },
    { label: "Blog", href: "https://github.com/diegosouzapw/RouteChi/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/diegosouzapw/RouteChi/issues/new/choose",
      external: true,
    },

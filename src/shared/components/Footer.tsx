...
const footerLinks = {
  ...
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/borhandarabi/routechi/discussions",
      external: true,
    },
  ],
  company: [
    { label: "About", href: "https://github.com/borhandarabi/routechi", external: true },
    { label: "Blog", href: "https://github.com/borhandarabi/routechi/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/borhandarabi/routechi/issues/new/choose",
      external: true,
    },

...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/diegosouzapw/RouteChi/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/diegosouzapw/RouteChi/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/diegosouzapw/RouteChi/blob/main/CHANGELOG.md";

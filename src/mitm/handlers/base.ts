 ...
 *   - forwarding to the RouteChi router (Next.js API)
 *   - SSE piping
...
export abstract class MitmHandlerBase {
   ...
   *   3. Call `this.fetchRouter(...)` for the RouteChi router round-trip.
  ...
  /**
   * Forward the prepared body to the RouteChi router (Next.js API).

 ...
 * `thinkingConfig`, …). The RouteChi router endpoint `/v1/chat/completions`
 ...
 *   - forward to `/v1/chat/completions` on the RouteChi router,
 ...
 * @param model      resolved RouteChi model string

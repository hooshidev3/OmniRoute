...
/**
 * Maps Arena leaderboard categories to RouteChi task-type categories.
 *
...
/**
 * RouteChi model aliases: canonical name → known aliases.
 * Creates additional DB entries for each alias so that models
 * are findable under any name RouteChi uses internally.
 */
 ...
 *
 * Leaderboard categories are mapped to RouteChi task types:
 * - "text" → default, review, documentation, debugging
 * - "code" → coding
 *
 * Known RouteChi model aliases are also expanded into additional entries.
 *

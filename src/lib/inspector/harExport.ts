 ...
 * trace out of RouteChi into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The RouteChi capture source
...
const CREATOR_NAME = "RouteChi Traffic Inspector";
